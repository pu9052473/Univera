        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-4 md:space-y-6">
            {sortedSlots.map((slot) => {
              const proxyStatus = getProxyStatusForSlot(slot.id)
              return (
                <div
                  key={slot.id}
                  ...
                  style={{ borderLeftColor: getBorderColor(slot.tag) }}
                >
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      >
                        <Button
                          ...
                          style={
                            {
                              "--hover-border-color": getBorderColor(slot.tag),
                              "--hover-bg-color":
                                getBackgroundColor(slot.tag) + "20",
                              "--hover-text-color": getBorderColor(slot.tag)
                            } as any
                          ...
                          onMouseEnter={(e) => {
                            const target = e.target as HTMLButtonElement
                            target.style.borderColor = getBorderColor(slot.tag)
                            target.style.backgroundColor =
                              getBackgroundColor(slot.tag) + "20"
                            target.style.color = getBorderColor(slot.tag)
                          }}
