...
//                   <X size={20} />
//                 </button>
//                 <h3 className="font-semibold text-lg mb-2 text-TextTwo">
//                   {faculty.user.name}
//                 </h3>
//                 <p className="text-sm mb-3 text-Dark">{faculty.user.email}</p>
//                 <div className="flex flex-wrap gap-2">
//                   {faculty.user.roles.map((role: any) => (
//                     <span
//                       key={role.id}
//                       className="px-3 py-1 rounded-full text-xs font-medium text-Dark bg-ColorOne"
//                     >
//                       {role.rolename}
//                     </span>
//                   ))}
...
//           <h2 className="text-2xl font-bold text-Dark">Available Faculties</h2>
//           {selectedFaculties.length > 0 && (
//             <div className="flex justify-end h-full">
//               <ButtonV1
//                 varient="outline"
//                 className="rounded-md text-xl py-4"
//                 disabled={submitting}
