...
//     try {
//       await axios.patch(`/api/class/students/${studentId}`, {
...
//         <p className="text-TextTwo text-lg">No students assigned to this class yet.</p>
//       </div>
//     );
//   }
...
//               <TableHead className="text-white font-semibold">Roll No</TableHead>
...
//                     <img
//                       src={student.user.imageUrl || "https://img.clerk.com/eyJ0eXBlIjoiZGVmYXVsdCIsImlpZCI6Imluc18yb21XZWFLSWtueG5RZFFSSWlsaDBZa2JlUEMiLCJyaWQiOiJ1c2VyXzJxdHpNR25LQTJPcTNQS0hQdzM3YXdiMHB5dSIsImluaXRpYWxzIjoiViJ9"}
...
//                     className="p-2 hover:bg-red-50 rounded-full transition-colors duration-150 group"
