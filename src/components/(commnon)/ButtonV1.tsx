...
export function ButtonV1({
  ...
  if (varient == "primary") {
    ...
    const primaryButtonClasses = clsx(
      "py-2 pl-2 pr-3 text-Dark border-2 rounded-lg border-Dark bg-white text-Dark flex gap-1.5 items-center transition-all duration-300 ease-in-out hover:text-white hover:border-white hover:bg-[#1A3E99] hover:shadow-lg",
      props.className
    )
