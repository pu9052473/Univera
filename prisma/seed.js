...
async function main() {
  ...
  const dAdmin = await prisma.user.create({
    data:{
      phone: "9898989898",
      id: "user_2q5BOONWDEW7dqa8bX1AI1EXKVP",
      email: "departmentadmin_btech@karnavatiuniversity.edu.in",
      name: "Engineering Admin",
      clerkId: "user_2q5BOONWDEW7dku578@karnavatiuniversity.edu.inqa8bX1AI1EXKVP",
      roles: {
        connect: {
          id: 3
        }
